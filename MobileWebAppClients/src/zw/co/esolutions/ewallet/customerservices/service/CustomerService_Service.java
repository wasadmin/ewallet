...
@WebServiceClient(name = "CustomerService", targetNamespace = "http://service.customerservices.ewallet.esolutions.co.zw/", wsdlLocation = "file:/META-INF/wsdl/CustomerService.wsdl")
    ...
    extends Service
{
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/META-INF/wsdl/CustomerService.wsdl");
