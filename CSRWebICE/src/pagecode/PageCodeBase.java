...
public abstract class PageCodeBase {
	...
	private ReferralServiceSOAPProxy referralService;
	private BankServiceSOAPProxy bankService;
	private AuditTrailServiceSOAPProxy auditService;
	private ContactDetailsServiceSOAPProxy contactService;
	private AlertsServiceSOAPProxy alertsService;
	private MerchantServiceSOAPProxy merchantService;
	...
	public void cleanUpSessionScope() {
		this.getSessionScope().remove("regInfo");
		
	}

	public CustomerServiceSOAPProxy getCustomerService() {
		if(customerService==null){
			this.customerService=new CustomerServiceSOAPProxy();
		}
	...
	public ProfileServiceSOAPProxy getProfileService() {
		if(this.profileService==null){
			this.profileService=new ProfileServiceSOAPProxy();
		}
		return profileService;
	}

	public void setProfileService(ProfileServiceSOAPProxy profileService) {
	...
	public ReferralServiceSOAPProxy getReferralService() {
		if(this.referralService==null){
			this.referralService=new ReferralServiceSOAPProxy();
		}
		return referralService;
	}

	public void setReferralService(ReferralServiceSOAPProxy referralService) {
	...
	public AuditTrailServiceSOAPProxy getAuditService() {
		if(auditService==null){
			auditService = new AuditTrailServiceSOAPProxy();
		}
		return auditService;
	}

	public void setAuditService(AuditTrailServiceSOAPProxy auditService) {
		this.auditService = auditService;
	}

	public ContactDetailsServiceSOAPProxy getContactService() {
		if(this.contactService==null){
			this.contactService=new ContactDetailsServiceSOAPProxy();
		}
		return contactService;
	}

	public void setContactService(ContactDetailsServiceSOAPProxy contactService) {
		this.contactService = contactService;
	}

	public AlertsServiceSOAPProxy getAlertsService() {
		if(alertsService==null){
			alertsService = new AlertsServiceSOAPProxy();
		}
		return alertsService;
	}

	public void setAlertsService(AlertsServiceSOAPProxy alertsService) {
		this.alertsService = alertsService;
	}

	public void setMerchantService(MerchantServiceSOAPProxy merchantService) {
		this.merchantService = merchantService;
	}

	public MerchantServiceSOAPProxy getMerchantService() {
		if (merchantService == null) {
			merchantService = new MerchantServiceSOAPProxy();
		}
