 ...
 *
 */
public class ViewAllWithdrawalsBean extends PageCodeBase{
	...
	public String search() {
        ...
        try {
			/*if(TransactionType.WITHDRAWAL_NONHOLDER.equals(transactionType)) {
				transactionType = TransactionType.EWALLET_TO_NON_HOLDER_TRANSFER;
			}*/
...
//				}
	...
	public List<SelectItem> getTxnTypeMenu() {
		if(this.txnTypeMenu == null) {
			...
			for(TransactionType type : TransactionType.values()) {
				if(type.equals(TransactionType.WITHDRAWAL) || type.equals(TransactionType.WITHDRAWAL_NONHOLDER)) {
	...
	public String viewPostings() {
		try {
			...
			super.getRequestScope().put("fromPage", "viewAllWithdrawals.jspx");
		} catch (Exception e) {
