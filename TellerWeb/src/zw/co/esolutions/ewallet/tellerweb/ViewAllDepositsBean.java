 ...
 *
 */
public class ViewAllDepositsBean extends PageCodeBase{
...
//				}
	...
	public List<SelectItem> getTxnTypeMenu() {
		if(this.txnTypeMenu == null) {
			...
			this.txnTypeMenu.add(new SelectItem(TransactionType.DEPOSIT.toString(), TransactionType.DEPOSIT.toString()));
			this.txnTypeMenu.add(new SelectItem(TransactionType.AGENT_CASH_DEPOSIT.toString(), TransactionType.AGENT_CASH_DEPOSIT.toString()));
	...
	public String viewPostings() {
		try {
			...
			super.getRequestScope().put("fromPage", "viewAllDeposits.jspx");
		} catch (Exception e) {
