...
public class DayEndManualResolve extends PageCodeBase {
...
private static Logger LOG ;
	...
	public String runDayEnd(){
		...
		LOG.debug("Run status :::::"+runResult);
			...
			if(runResult){
				...
				if(dayId!=null){
					...
					gotoPage("/teller/tellerdayEndSummary.jspx");
							...
							super.setErrorMessage("Operation aborted.");
						}
			...
			super.setErrorMessage("Operation aborted.System Error occurred");
			e.printStackTrace();
		}
		return "";
	}
	...
	public List<DayEnd> getDayEnds() {
		ProcessServiceSOAPProxy proxy= new ProcessServiceSOAPProxy();
		this.dayEnds=proxy.getDayEndByDayEndStatusAndBranch(zw.co.esolutions.ewallet.process.DayEndStatus.MANUALLY_RESOLVE,super.getJaasUserName());
	...
	public String viewDayEnd() {
		...
		super.gotoPage("/teller/dayEndManualSummary.jspx");
