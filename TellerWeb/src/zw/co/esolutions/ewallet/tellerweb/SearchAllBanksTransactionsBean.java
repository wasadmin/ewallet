 ...
 *
 */
public class SearchAllBanksTransactionsBean extends PageCodeBase{
	 ...
	 * 
	 */
	public SearchAllBanksTransactionsBean() {
...
;					 
	...
	public String viewPostings() {
		try {
			...
			super.getRequestScope().put("fromPage", "searchAllBanksTransactions.jspx");
		} catch (Exception e) {
