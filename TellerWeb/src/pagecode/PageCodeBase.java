...
public abstract class PageCodeBase {
	...
	private ContactDetailsServiceSOAPProxy contactDetailsService;
	private LimitServiceSOAPProxy limitService;
	...
	public BankServiceSOAPProxy getBankService() {
		if (bankService == null) {
			bankService = new BankServiceSOAPProxy();
	...
	public ContactDetailsServiceSOAPProxy getContactDetailsService() {
		if (contactDetailsService == null) {
			contactDetailsService = new ContactDetailsServiceSOAPProxy();
	...
	public LimitServiceSOAPProxy getLimitService() {
		if (limitService == null) {
			limitService = new LimitServiceSOAPProxy();
	...
	public ReferralServiceSOAPProxy getReferralService() {
		if (referralService == null) {
			referralService = new ReferralServiceSOAPProxy();
