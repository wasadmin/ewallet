 ...
 *
 */
public class RegisterCustomer4 extends PageCodeBase {
	...
	protected SelectInputDate calendar1;
	...
	protected SelectInputDate getCalendar1() {
		if (calendar1 == null) {
			calendar1 = (SelectInputDate) findComponentInRoot("calendar1");
		}
		return calendar1;
	}
