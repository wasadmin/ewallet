...
import zw.co.esolutions.ewallet.tellerweb.ViewLogsBean;

/**
 * @author stanford
 *
 */
public class ViewLogs extends PageCodeBase {
	...
	protected ViewLogsBean viewLogsBean;
	 ...
	 * @managed-bean true
	 */
	protected ViewLogsBean getViewLogsBean() {
		if (viewLogsBean == null) {
			viewLogsBean = (ViewLogsBean) getManagedBean("viewLogsBean");
		}
		return viewLogsBean;
	}
	 ...
	 * @managed-bean true
	 */
	protected void setViewLogsBean(ViewLogsBean viewLogsBean) {
		this.viewLogsBean = viewLogsBean;
	}
