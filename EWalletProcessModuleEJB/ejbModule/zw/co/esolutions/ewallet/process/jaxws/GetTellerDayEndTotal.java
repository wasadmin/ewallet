...
@XmlRootElement(name = "getTellerDayEndTotal", namespace = "http://process.ewallet.esolutions.co.zw/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getTellerDayEndTotal", namespace = "http://process.ewallet.esolutions.co.zw/", propOrder = {
    "bankName",
    "profileId",
    "txnDate",
    "msgType"
