...
@XmlRootElement(name = "getProcessTransactionsWithinDateRangeByMsgType", namespace = "http://process.ewallet.esolutions.co.zw/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getProcessTransactionsWithinDateRangeByMsgType", namespace = "http://process.ewallet.esolutions.co.zw/", propOrder = {
    "fromDate",
    "toDate",
    "msgType",
    "status"
