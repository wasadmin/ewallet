...
@XmlRootElement(name = "approveDayEnd", namespace = "http://process.ewallet.esolutions.co.zw/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "approveDayEnd", namespace = "http://process.ewallet.esolutions.co.zw/", propOrder = {
    "dayEnd",
    "userName"
})
