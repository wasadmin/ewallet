...
@XmlRootElement(name = "updateDayEnd", namespace = "http://process.ewallet.esolutions.co.zw/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "updateDayEnd", namespace = "http://process.ewallet.esolutions.co.zw/", propOrder = {
    "dayEnd",
    "userName"
})
