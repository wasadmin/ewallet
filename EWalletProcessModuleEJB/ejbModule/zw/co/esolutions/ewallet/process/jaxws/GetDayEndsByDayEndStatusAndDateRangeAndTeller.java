...
@XmlRootElement(name = "getDayEndsByDayEndStatusAndDateRangeAndTeller", namespace = "http://process.ewallet.esolutions.co.zw/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getDayEndsByDayEndStatusAndDateRangeAndTeller", namespace = "http://process.ewallet.esolutions.co.zw/", propOrder = {
    "fromDate",
    "toDate",
    "dayEndStatus",
    "tellerid"
