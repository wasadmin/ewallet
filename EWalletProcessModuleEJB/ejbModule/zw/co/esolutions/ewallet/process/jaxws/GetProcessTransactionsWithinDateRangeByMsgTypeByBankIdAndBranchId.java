...
@XmlRootElement(name = "getProcessTransactionsWithinDateRangeByMsgTypeByBankIdAndBranchId", namespace = "http://process.ewallet.esolutions.co.zw/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getProcessTransactionsWithinDateRangeByMsgTypeByBankIdAndBranchId", namespace = "http://process.ewallet.esolutions.co.zw/", propOrder = {
    "fromDate",
    "toDate",
    "msgType",
    "bankId",
