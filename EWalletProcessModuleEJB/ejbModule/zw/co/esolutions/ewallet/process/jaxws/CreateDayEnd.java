...
@XmlRootElement(name = "createDayEnd", namespace = "http://process.ewallet.esolutions.co.zw/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "createDayEnd", namespace = "http://process.ewallet.esolutions.co.zw/", propOrder = {
    "dayEnd",
    "userName"
})
