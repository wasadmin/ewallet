...
@XmlRootElement(name = "getPocessTransactionsByDateRangeAndStatus", namespace = "http://process.ewallet.esolutions.co.zw/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getPocessTransactionsByDateRangeAndStatus", namespace = "http://process.ewallet.esolutions.co.zw/", propOrder = {
    "fromDate",
    "toDate",
    "status"
})
public class GetPocessTransactionsByDateRangeAndStatus {
