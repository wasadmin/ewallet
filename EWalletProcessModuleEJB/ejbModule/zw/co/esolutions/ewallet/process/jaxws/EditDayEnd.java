...
@XmlRootElement(name = "editDayEnd", namespace = "http://process.ewallet.esolutions.co.zw/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "editDayEnd", namespace = "http://process.ewallet.esolutions.co.zw/", propOrder = {
    "dayEnd",
    "userName"
})
