...
@XmlRootElement(name = "getProcessTransactionsWithinDateRangeByBankId", namespace = "http://process.ewallet.esolutions.co.zw/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getProcessTransactionsWithinDateRangeByBankId", namespace = "http://process.ewallet.esolutions.co.zw/", propOrder = {
    "fromDate",
    "toDate",
    "bankId",
    "status"
})
public class GetProcessTransactionsWithinDateRangeByBankId {
