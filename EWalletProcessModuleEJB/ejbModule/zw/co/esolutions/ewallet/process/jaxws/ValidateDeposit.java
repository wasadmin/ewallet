...
@XmlRootElement(name = "validateDeposit", namespace = "http://process.ewallet.esolutions.co.zw/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "validateDeposit", namespace = "http://process.ewallet.esolutions.co.zw/", propOrder = {
    "sourceMobileId",
    "amount",
    "bankId",
    "locationType"
