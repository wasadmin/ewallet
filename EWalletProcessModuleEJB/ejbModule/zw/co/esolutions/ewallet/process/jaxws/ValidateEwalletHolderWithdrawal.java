...
@XmlRootElement(name = "validateEwalletHolderWithdrawal", namespace = "http://process.ewallet.esolutions.co.zw/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "validateEwalletHolderWithdrawal", namespace = "http://process.ewallet.esolutions.co.zw/", propOrder = {
    "sourceMobileId",
    "amount",
    "bankId",
    "locationType"
