...
@XmlRootElement(name = "getProcessTransactionsWithinDateRangeByBankIdAndBranchId", namespace = "http://process.ewallet.esolutions.co.zw/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getProcessTransactionsWithinDateRangeByBankIdAndBranchId", namespace = "http://process.ewallet.esolutions.co.zw/", propOrder = {
    "fromDate",
    "toDate",
    "bankId",
    "branchId",
...
public class GetProcessTransactionsWithinDateRangeByBankIdAndBranchId {
