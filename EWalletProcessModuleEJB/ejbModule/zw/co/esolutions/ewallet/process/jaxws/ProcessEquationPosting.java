...
@XmlRootElement(name = "processEquationPosting", namespace = "http://process.ewallet.esolutions.co.zw/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "processEquationPosting", namespace = "http://process.ewallet.esolutions.co.zw/", propOrder = {
    "dayEnd",
    "processTxn",
    "userName"
})
