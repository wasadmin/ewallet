...
@XmlRootElement(name = "getProcessTransactionsWithinDateRange", namespace = "http://process.ewallet.esolutions.co.zw/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getProcessTransactionsWithinDateRange", namespace = "http://process.ewallet.esolutions.co.zw/", propOrder = {
    "fromDate",
    "toDate",
    "status"
})
public class GetProcessTransactionsWithinDateRange {
