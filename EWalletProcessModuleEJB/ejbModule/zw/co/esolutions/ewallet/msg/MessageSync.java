...
//    	t.setOwnerType(zw.co.esolutions.mcommerce.msg.TariffTable.OwnerType.Enum.forString(table.getOwnerType().toString()));
    	t.setBankId(table.getBankId());
//    	t.setCustomerClass(table.getCustomerClass().toString());
...
//    	t.setOwnerId(table.getOwnerId());
//    	t.setTariffTableType(table.getType().name());
    	MessageSync.sync(doc.toString());
