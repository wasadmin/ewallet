...
<% String mobile = request.getParameter("mobileNumber");
	...
	String amount = request.getParameter("rtgsAmount");
	String targetAccount = request.getParameter("destAccount");
	...
	try {
		...
		if(mobile.equals(targetAccount)) {
			...
			if( longAmnt > 0L) { 		
				MobileWebRequestMessage req = TransactionUtil.populateBasicMobileWebRequestMessage(GenerateKey.generateEntityId(), bankId, mobile, longAmnt, srcAccount, MobileWebTransactionType.RTGS);
