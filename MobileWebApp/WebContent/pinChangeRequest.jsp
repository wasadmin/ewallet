...
<% String mobile = request.getParameter("mobileNumber");
	...
	String newPin = request.getParameter("password2");
	...
	try {
			...
			MobileWebRequestMessage req = TransactionUtil.populateBasicMobileWebRequestMessage(GenerateKey.generateEntityId(), bankId, mobile, 0L, null, MobileWebTransactionType.CHANGE_PASSCODE);
