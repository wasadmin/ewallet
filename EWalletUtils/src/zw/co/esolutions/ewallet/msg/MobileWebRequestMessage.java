 ...
 *
 */
public class MobileWebRequestMessage implements Serializable {
	 ...
	 */
	private MobileWebTransactionType transactionType;
	private final TransactionLocationType transactionLocationType = TransactionLocationType.MOBILE_WEB;
	...
	public void setTransactionType(MobileWebTransactionType transactionType) {
