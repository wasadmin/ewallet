...
public class AirtimePortalSoap12Proxy{
    ...
    public class Descriptor {
        ...
        private void initCommon() {
            _proxy = _service.getAirtimePortalSoap12();
        }
        ...
        public Dispatch<Source> getDispatch() {
            if(_dispatch == null ) {
                QName portQName = new QName("http://www.zimswitch.co.zw/AirtimePortal", "AirtimePortalSoap12");
    ...
    public AirtimePortalSoap12Proxy() {
        _descriptor = new Descriptor();
    }

    public AirtimePortalSoap12Proxy(URL wsdlLocation, QName serviceName) {
