...
public class SmsPortalSoapProxy{
    ...
    public class Descriptor {
        ...
        private void initCommon() {
            _proxy = _service.getSmsPortalSoap();
        }
        ...
        public Dispatch<Source> getDispatch() {
            if(_dispatch == null ) {
                QName portQName = new QName("http://www.zimswitch.co.zw/SmsPortal", "SmsPortalSoap");
    ...
    public SmsPortalSoapProxy() {
        _descriptor = new Descriptor();
    }

    public SmsPortalSoapProxy(URL wsdlLocation, QName serviceName) {
