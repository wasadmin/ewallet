...
@WebServiceClient(name = "MerchantService", targetNamespace = "http://service.merchantservices.ewallet.esolutions.co.zw/", wsdlLocation = "http://localhost:9081/MerchantServices/MerchantService/MerchantService.wsdl")
public class MerchantService_Service extends Service {
	...
	static {
		URL url = null;
		try {
			url = new URL("http://localhost:9081/MerchantServices/MerchantService/MerchantService.wsdl");
	...
	/**
	 * 
	 * @return returns MerchantService
	 */
