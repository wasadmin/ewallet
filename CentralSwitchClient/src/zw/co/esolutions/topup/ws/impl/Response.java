 ...
 *         &lt;element name="request" type="{http://impl.ws.topup.esolutions.co.zw/}request" minOccurs="0"/>
...
@XmlType(name = "response", namespace = "http://impl.ws.topup.esolutions.co.zw/", propOrder = {
    "airtimeBalance",
    "initialBalance",
    "narrative",
    "request",
